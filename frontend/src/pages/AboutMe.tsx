  ...
  return(
    <div className='center-content'>
      <div className={aboutme.aboutmeContainer}>
        <h1>About me</h1>
        <div className={`container ${aboutme.aboutmeDesc}`}>
        ...
        <div className={aboutme.socialsContainer}>
          <h3>Socials</h3>
          <div className={`container ${aboutme.socialsLinks}`}>
            <a href="https://github.com/danielpodgornyy">
              <img src="/images/github.svg" alt="github-logo" className={aboutme.socialImg}></img>
            </a> 
            <a href="https://www.linkedin.com/in/daniel-podgornyy-956b52213/">
              <img src="/images/linkedin.svg" alt="github-logo" className={aboutme.socialImg}></img>
            </a> 
          </div>
        </div>
      </div>
